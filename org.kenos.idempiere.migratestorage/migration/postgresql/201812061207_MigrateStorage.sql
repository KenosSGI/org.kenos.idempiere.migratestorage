...
INSERT INTO AD_Process (AD_Process_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,IsReport,Value,IsDirectPrint,Classname,AccessLevel,EntityType,Statistic_Count,Statistic_Seconds,IsBetaFunctionality,IsServerProcess,ShowHelp,CopyFromProcess,AD_Process_UU) VALUES (200106,0,0,'Y',TO_TIMESTAMP('2018-12-06 11:23:36','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-12-06 11:23:36','YYYY-MM-DD HH24:MI:SS'),100,'Migrate Storage Provider','This tool will help the migration of storage provider','You can migrate from attachments and archives from Database to File System and vice-versa. 
** This process will change sensitive data, always make sure you have a backup before start this process **','N','MigrateStorageProvider','N','org.kenos.idempiere.migratestorage.process.MigrateStorageProvider','4','U',0,0,'N','N','Y','N','53889806-6e00-48ae-a200-4d8dafd21603')
;

-- 06/12/2018 11h23min51s BRST
UPDATE AD_Process SET EntityType='A',Updated=TO_TIMESTAMP('2018-12-06 11:23:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=200106
;

-- 06/12/2018 11h24min56s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (200251,0,0,'Y',TO_TIMESTAMP('2018-12-06 11:24:56','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-12-06 11:24:56','YYYY-MM-DD HH24:MI:SS'),100,'File_Directory',200106,10,38,'N',0,'Y','File_Directory','Y','A',50022,'f742e54e-cb04-4a8f-b5ae-dc5f1277b4d9','N')
;

-- 06/12/2018 11h26min32s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_Process_ID,SeqNo,AD_Reference_ID,AD_Reference_Value_ID,IsRange,FieldLength,IsMandatory,DefaultValue,ColumnName,DefaultValue2,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (200252,0,0,'Y',TO_TIMESTAMP('2018-12-06 11:26:31','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-12-06 11:26:31','YYYY-MM-DD HH24:MI:SS'),100,'Method',200106,20,17,200019,'Y',0,'Y','DB','Method','FileSystem','Y','A',200239,'b530db9c-47c5-4322-9653-27d9c1987093','N')
;

-- 06/12/2018 11h27min34s BRST
INSERT INTO AD_Menu (AD_Menu_ID,Name,"action",AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSummary,AD_Process_ID,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,AD_Menu_UU) VALUES (200164,'Migrate Storage Provider','P',0,0,'Y',TO_TIMESTAMP('2018-12-06 11:27:34','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-12-06 11:27:34','YYYY-MM-DD HH24:MI:SS'),100,'N',200106,'Y','N','A','Y','c3c3ae6c-6d4e-45a3-8a68-9f3f33b2db8d')
;

-- 06/12/2018 11h27min34s BRST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 200164, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200164)
;
...
-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=17, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1120016
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=18, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000006
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=19, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000009
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=20, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000012
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=21, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000010
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=22, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000015
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=23, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000013
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=24, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000011
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=25, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000014
;

-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=26, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=2000016
;
...
-- 06/12/2018 11h28min55s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=156, SeqNo=16, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=200164
;
